...
class MockAIPlanningProvider:
    ...
    async def chat_turn(
        ...
        *,
        ...
        text = (
            f"Понял: «{snippet}». Сейчас опираюсь на параметры вокруг {city}. "
            "Могу уточнить длительность, интересы или темп — либо напишите "
            "«подбери маршрут», и соберу предложение."
        )
